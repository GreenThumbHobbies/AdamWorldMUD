...
const WT = {
  ...
  dungeon_armory:  {zone:'THE DUNGEON — UPPER',name:'Dungeon Armory',desc:'Racks of rotted wood. One intact chest, lock smashed. The passage south leads back toward the hall. Stairs descend further north into the lower dungeon.',exits:{south:'dungeon_hall',down:'mid_dungeon'},base:['iron key','bone shard'],mon:[M('armor_skel','Armored Skeleton',22,6,3,50,10,'bone shard')],shop:null},
  ...
  // Dungeon Lower
  mid_dungeon:     {zone:'THE DUNGEON — LOWER',name:'The Descent',desc:'The corridor narrows. Stone older than memory. The cold is profound. Stairs climb up toward the dungeon armory. East leads to the dragon\'s lair. West leads to the void temple. South leads to the Lich\'s antechamber. A hidden passage leads up toward the temple crypt.',exits:{up:'dungeon_armory',south:'boss_antechamber',east:'dragon_lair',west:'void_temple'},base:[],mon:[M('shadow_wraith','Shadow Wraith',30,8,2,75,15,'void crystal')],shop:null},
  ...
  boss_antechamber:{zone:'THE DUNGEON — LOWER',name:'Antechamber of the Lich',desc:'Skeletal soldiers at attention. A black iron door looms south toward the Lich\'s chamber. The passage north leads back to the Descent.',exits:{north:'mid_dungeon',south:'boss_chamber'},base:[],mon:[M('lich_champion',"Lich's Champion",45,11,4,150,35,'enchanted gem')],shop:null},
  boss_chamber:    {zone:'THE DUNGEON — LOWER',name:"The Lich's Chamber",desc:'Arcane sigils burn in cold blue fire. Upon a throne of bones sits the Dungeon Lich. A trapdoor in the floor is sealed with void runes — beyond it lies something older than the dungeon itself.',exits:{north:'boss_antechamber',down:'void_sanctum'},base:[],mon:[M('dungeon_lich','Dungeon Lich',80,14,5,500,100,"Lich's Crown")],shop:null},
  // Adventure zones
